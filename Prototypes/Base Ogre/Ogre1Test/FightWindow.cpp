...
bool FightWindow::configure(void)
{
...
void FightWindow::createCamera(void)
{
	camera_ = sceneMgr_->createCamera("PlayerCam");

	camera_->setPosition(Ogre::Vector3(0,0,100)); //Base position at the 1m from the ground
...
void FightWindow::createResourceListener(void)
{
}
//---------------------------------------------------------------------------
