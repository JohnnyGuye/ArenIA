...
*
* @author Johnny Guye
* @summary : This class is a victory handler wich wait the end of a day before victory.
*/

#include "victoryhandler.h"
class EndOfDayVictory :
	public VictoryHandler
{
public:
	EndOfDayVictory(void);
	virtual ~EndOfDayVictory(void);
